...
const styles = StyleSheet.create({
  ...
  emergencyBadge: { backgroundColor: "#FFEBEE", borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4, alignSelf: "flex-start", marginBottom: 10, marginHorizontal: 14 },
  emergencyText: { color: COLORS.emergency, fontWeight: "700", fontSize: 12 },
  header: { flexDirection: "row", alignItems: "center", marginBottom: 10, paddingHorizontal: 14, paddingTop: 14 },
  ...
  videoContainer: { width: "100%", aspectRatio: 16 / 9, backgroundColor: "#000", marginBottom: 0, overflow: "hidden" },
  ...
  actions: { flexDirection: "row", borderTopWidth: 1, borderTopColor: COLORS.border, paddingTop: 10, paddingBottom: 10, paddingHorizontal: 14, gap: 20, alignItems: "center", marginTop: 10 },
  actionBtn: { flexDirection: "row", alignItems: "center", gap: 6 },
  actionIcon: { fontSize: 20 },
  actionCount: { fontSize: 14, color: COLORS.muted, fontWeight: "600" },
  coursBadge: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "#E8F5E9", borderRadius: 10, paddingHorizontal: 12, paddingVertical: 6, marginBottom: 10, marginHorizontal: 14 },
  coursBadgeText: { color: COLORS.primary, fontWeight: "700", fontSize: 13 },
  coursAccessLabel: { color: "#2E7D32", fontSize: 12, fontWeight: "600" },
  coursGate: { backgroundColor: "#F3F4F6", borderRadius: 14, padding: 18, marginBottom: 12, marginHorizontal: 14, alignItems: "center", borderWidth: 1, borderColor: "#E9ECEF", borderStyle: "dashed" as any },
  ...
  sponsoredBadge: { backgroundColor: "#FFF3E0", borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4, alignSelf: "flex-start", marginBottom: 8, marginHorizontal: 14, borderWidth: 1, borderColor: "#FFCC80" },
