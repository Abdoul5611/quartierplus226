...
const GAMES: GameCard[] = [
  ...
  },
  {
    ...
    subtitle: "Grattez 9 cases et trouvez 3 symboles identiques pour gagner !",
    icon: "layers-outline",
    color: COLORS.gold,
  ...
  },
  {
    id: "quiz",
    title: "Quiz Quartier",
    subtitle: "Testez vos connaissances sur votre quartier. 100 FCFA par bonne réponse.",
    icon: "help-circle-outline",
    color: COLORS.blue,
    bgColor: COLORS.blueLight,
    cost: "25 FCFA / question",
    maxWin: "500 FCFA",
    route: "QuizQuartier",
    available: true,
  },
  ...
  {
    id: "agilite",
    title: "Course d'Agilité",
    subtitle: "Clique le plus de fois en 10s pour faire avancer ton coureur. Le meilleur score gagne !",
    icon: "flash",
    color: "#E65100",
    bgColor: "#FFF3E0",
    cost: "Gratuit",
  ...
  },
  {
    id: "keno",
    title: "Keno Express",
    subtitle: "Choisissez 5 numéros parmi 30 — le système en tire 10. Chaque numéro trouvé multiplie vos gains !",
    icon: "grid-outline",
    color: "#00838F",
    bgColor: "#E0F7FA",
    cost: "75 FCFA",
  ...
  },
  {
    id: "livequiz",
    title: "Live Quiz",
    subtitle: "Jouez en direct contre vos voisins ! Chrono 10s, Grand Partage de la cagnotte.",
    icon: "radio",
    color: "#AD1457",
    bgColor: "#FCE4EC",
    cost: "5 pubs à regarder",
    maxWin: "Cagnotte partagée",
    route: "LiveQuiz",
    available: true,
  },
  {
